"""HTTPS CONNECT allowlist for an authenticated, loopback-only kubectl tunnel."""
...
def main() -> None:
    ...
    targets = {host.casefold(): (host, 443) for host in args.allow_host}
    logging.basicConfig(level=logging.INFO)
    with ProxyServer(("0.0.0.0", args.port), targets) as server:

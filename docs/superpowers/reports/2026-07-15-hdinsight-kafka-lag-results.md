...
| Cap-4MB | C=11MB/s | 1688 msgs/s = 16.5 MB/s (100%) | — | — | ⏳ |
| Cap-5MB | C=13.7MB/s | 1688 msgs/s = 16.5 MB/s (100%) | — | — | ⏳ |
...
### Arm Cap (부하 100% 고정, 컨슈머 용량 증대) — ⏳ 실행 중

_(부하를 못 줄이는 고객의 실효 대안: 동일 100% 부하에서 C를 올려 회복<60s 달성 가능한지 실측)_

...
![Architecture](images/pod_db_query_latency.png)

## 현재 상황: 메트릭 분석

### DB 쿼리 지연

![MySQL query latency](images/01_query_latency.png)
...
![Pod runtime metrics](images/02_pod_runtime.png)
...
![Deployment YAML (cpu limit 2)](images/result_01.png)

### 변화 전후 비교

![APM endpoint latency after change](images/result_02.png)

![Pod runtime after change](images/result_pod_runtime.png)

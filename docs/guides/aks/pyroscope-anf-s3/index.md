...
applies_to:
- 공식 원문 재검토 필요
title: AKS Pyroscope와 Azure NetApp Files S3 배포
description: Pyroscope을 AKS에 배포하고 Azure NetApp Files S3를 백엔드로 구성합니다.
technologies:
- kubernetes
- python
tags:
...
![Pyroscope 프로파일링 아키텍처 (Python Pod → Pyroscope → ANF)](images/architecture.png)
...
![Pyroscope UI - ai-foundry-chat flame graph](images/pyroscope_ui.png)
...
![Create certificate options (Microsoft Learn)](images/anf-create-certificate.png)

버킷 생성 메뉴 (Name / Path / UID·GID / Permissions / Certificate):

![Create a bucket menu (Microsoft Learn)](images/anf-create-bucket.png)
...
> 예제 코드: [pyroscope-chat-profiling/](https://github.com/hellices/devguidesample/tree/main/samples/aks/source-material/pyroscope-chat-profiling)
> ([app.py](https://github.com/hellices/devguidesample/blob/main/samples/aks/source-material/pyroscope-chat-profiling/app.py) · [deployment.yaml](https://github.com/hellices/devguidesample/blob/main/samples/aks/source-material/pyroscope-chat-profiling/deployment.yaml) · [deploy.sh](https://github.com/hellices/devguidesample/blob/main/samples/aks/source-material/pyroscope-chat-profiling/deploy.sh) · [test.py](https://github.com/hellices/devguidesample/blob/main/samples/aks/source-material/pyroscope-chat-profiling/test.py))

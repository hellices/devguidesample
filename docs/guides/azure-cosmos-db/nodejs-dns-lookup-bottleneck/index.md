...
applies_to:
- 공식 원문 재검토 필요
title: Cosmos DB 연속 쿼리 DNS Lookup 병목 진단
description: 낮은 CPU 환경의 연속 쿼리에서 발생하는 DNS lookup 병목을 진단하고 완화합니다.
technologies:
- nodejs
- cosmos-db
tags:
...
http.get('http://cosmos-example-northeurope.documents.azure.com', (res) => {

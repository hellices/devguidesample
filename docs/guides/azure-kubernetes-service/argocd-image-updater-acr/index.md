...
applies_to:
- 공식 원문 재검토 필요
title: Argo CD Image Updater와 ACR 연동
description: AKS에서 Argo CD Image Updater가 Azure Container Registry 이미지를 갱신하도록 구성합니다.
technologies:
- kubernetes
- gitops
tags:
...
# clientId: 예) <managed-identity-client-id>
# principalId: 예) <managed-identity-principal-id>
...
```yaml
imageName: acrexamplekrc01.azurecr.io/test-app:1.0.0  # ❌
imageName: acrexamplekrc01.azurecr.io/test-app         # ✅
```

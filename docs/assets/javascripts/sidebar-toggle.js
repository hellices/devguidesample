(function () {
  ...
  function applyState(root, button, storage, collapsed) {
    ...
    button.setAttribute("aria-label", collapsed ? "왼쪽 메뉴 펼치기" : "왼쪽 메뉴 접기");
  ...
  function mountSidebarToggle(documentRef, windowRef) {
    ...
    button.setAttribute("aria-label", "왼쪽 메뉴 접기");
  ...
  if (typeof module !== "undefined" && module.exports) {
    module.exports = {mountSidebarToggle, readStoredState, applyState};
  }

...
title: HDInsight Kafka 모니터링 방식 비교
description: Ambari, Azure Monitor, JMX Exporter와 Kafka Exporter 기반 모니터링을 비교합니다.
technologies:
- kafka
- prometheus
tags:
...
> - 설치·대시보드 구성: **[Prometheus + Grafana 구성 가이드](prometheus-grafana/index.md)**
...
- **활성화**: Azure Portal → 클러스터 → **Monitoring > Monitor integration** → Log Analytics 워크스페이스 연결
  ...
  ![HDInsight Monitor integration 활성화 화면](images/hdinsight_monitor_integration_1.png)
...
설치·대시보드: **[Prometheus + Grafana 구성 가이드](prometheus-grafana/index.md)**

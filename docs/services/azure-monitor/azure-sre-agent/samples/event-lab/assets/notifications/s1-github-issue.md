...
Telemetry source: `appi-sre-event-lab-example`
...
- Detailed validation appendix: [Azure SRE Agent validation results](https://github.com/hellices/devguidesample/blob/main/docs/services/azure-monitor/azure-sre-agent/validation-results/index.md)

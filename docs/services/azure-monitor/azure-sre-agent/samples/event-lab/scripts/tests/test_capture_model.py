...
def test_redact_replaces_container_app_fqdn_preserving_surrounding_text():
    ...
    redacted = model.redact(
        ...
        "--write-out '%{http_code}\\n' --max-time 15 "
        "https://ca-sre-event-lab.example-env.koreacentral"
...
def test_redact_replaces_multiple_container_app_fqdns_in_one_string():
    ...
    value = (
        "for host in \\\n"
        "  ca-sre-event-lab.example-env.koreacentral"
        ".azurecontainerapps.io \\\n"
        "  ca-sre-event-lab-vnet.example-vnet-env.koreacentral"
    ...
    redacted = model.redact(
        {
            ...
            "nested": [
                "see ca-sre-event-lab-vnet.example-vnet-env.koreacentral"
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        ".example-env.koreacentral.azurecontainerapps"

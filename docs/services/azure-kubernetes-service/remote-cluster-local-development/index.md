...
applies_to:
- 공식 원문 재검토 필요
title: AKS 원격 클러스터와 로컬 개발 루프
description: Telepresence와 mirrord를 이용해 AKS 트래픽을 로컬 개발 환경으로 연결합니다.
technologies:
- kubernetes
- python
tags:
...
예제 파일: [`local-development-loop/`](https://github.com/hellices/devguidesample/tree/main/docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop)
...
- Azure CLI, `kubectl`, AKS 클러스터 (예시: `aks-example-koreacentral-01` @ `rg-example-koreacentral-01`)
...
kubectl apply -f docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop/k8s/echo-service.yaml
...
python3 docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop/local/local-server.py &
...
```jsonc
// docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop/local/mirrord.json
{
...
mirrord exec -f docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop/local/mirrord.json -- \
  python3 docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop/local/local-server.py
...
// .vscode/launch.json
{
  ...
  "type": "debugpy",
  "request": "launch",
  "program": "${workspaceFolder}/docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop/local/local-server.py",
...
# 샘플 서비스 제거
kubectl delete -f docs/services/azure-kubernetes-service/remote-cluster-local-development/samples/local-development-loop/k8s/echo-service.yaml

...
- λ가 클수록 빨리 잊는다. **half-life는 도메인과 기억 유형에 따라 수십 분에서 수백 일까지 벌어진다** — 단일 값을 쓰면 안 된다. 유형별 권장치는 [01. 메모리 분류 체계의 Retention 정책 표](../taxonomy/index.md)와 [06. 커머스 적용 설계 §6](../commerce/index.md) 참조
...
- [04. 프레임워크 비교](../frameworks/index.md) — 직접 만들 것인가 가져다 쓸 것인가
- [05. 프로덕션과 평가](../production-evaluation/index.md) — 이 파이프라인을 규모에서 운영하기
